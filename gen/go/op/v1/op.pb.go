...
const file_op_v1_op_proto_rawDesc = "" +
	"\n" +
	"\x0eop/v1/op.proto\x12\x05op.v1\x1a\x1esophia_who/v1/sophia_who.proto\",\n" +
	...
	"\x06stderr\x18\x03 \x01(\tR\x06stderr2\x96\x03\n" +
	"\tOPService\x12;\n" +
	...
	"\fShowIdentity\x12\".sophia_who.v1.ShowIdentityRequest\x1a#.sophia_who.v1.ShowIdentityResponseB;Z9github.com/organic-programming/grace-op/gen/go/op/v1;opv1b\x06proto3"
...
var file_op_v1_op_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_op_v1_op_proto_goTypes = []any{
	...
	(*v1.CreateIdentityResponse)(nil), // 9: sophia_who.v1.CreateIdentityResponse
	(*v1.ListIdentitiesResponse)(nil), // 10: sophia_who.v1.ListIdentitiesResponse
	(*v1.ShowIdentityResponse)(nil),   // 11: sophia_who.v1.ShowIdentityResponse
}
var file_op_v1_op_proto_depIdxs = []int32{
	...
	1,  // 7: op.v1.OPService.Discover:output_type -> op.v1.DiscoverResponse
	4,  // 8: op.v1.OPService.Invoke:output_type -> op.v1.InvokeResponse
	9,  // 9: op.v1.OPService.CreateIdentity:output_type -> sophia_who.v1.CreateIdentityResponse
	10, // 10: op.v1.OPService.ListIdentities:output_type -> sophia_who.v1.ListIdentitiesResponse
	11, // 11: op.v1.OPService.ShowIdentity:output_type -> sophia_who.v1.ShowIdentityResponse
